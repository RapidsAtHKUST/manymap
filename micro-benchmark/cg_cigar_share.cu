...
// #define MAXMEM 32100000 // 4000, 8
// #define MAXMEM 2100000 // 1k 2016000
// #define MAXMEM 8100000 // 2k, 8032000 
#define MAXMEM 32100000 // 4k, 32064000
// #define MAXMEM 123400000 // 8k, 128128000+64000
// #define MAXMEM 512400000 // 16k, 512256000+128000
// #define MAXMEM 2049000000 // 32k, 2048512000+256000
...
{	
	...
	for (int i = 0; i < nkernel; ++i) {
		...
		cudaLaunchCooperativeKernel((void*)ksw_extd2_kernel, nblock, nthread, args, smem_size, streams[i]);
	...
	// 	ksw_extd2_kernel<<<nblock, nthread, smem_size, streams[sid]>>>((void*)((int8_t*)d_gm + sid * (size_t)MAXMEM), qlen, &d_query[sid * MAXLEN], tlen, &d_target[sid * MAXLEN], q, e, q2, e2, w, zdrop, &d_ez[i]);
