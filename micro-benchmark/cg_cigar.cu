...
// #define NSTREAM 128
// #define NSTREAM 64 // 8k
// #define NSTREAM 16 // 16k
#define NSTREAM 4 // 32k

// #define MAXMEM 2100000 // 1k 2016000
// #define MAXMEM 8100000 // 2k, 8032000 
// #define MAXMEM 32100000 // 4k, 32064000
#define MAXMEM 123400000UL // 8k, 128128000+64000
// #define MAXMEM 512400000UL // 16k, 512256000+128000
// #define MAXMEM 2049000000UL // 32k, 2048512000+256000
...
{	
	...
	for (int i = 0; i < nkernel; ++i) {
		void *gm = (void*)((int8_t*)d_gm + i * (size_t)MAXMEM);
		...
		cudaLaunchCooperativeKernel((void*)ksw_extd2_kernel, nblock, nthread, args, 0, streams[i]);
